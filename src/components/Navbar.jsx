...
const NAVBAR_HEIGHT = 56; // fixed navbar height in px
...
const Navbar = () => {
  ...
  return (
    <>
        ...
        <div className="w-full flex justify-between items-center max-w-7xl mx-auto" style={{ height: '100%' }}>
          ...
          >
            ...
            <motion.div
              ...
              // Removed onClick handler that opens modal
              tabIndex={0}
              aria-label="Logo avatar"
              onKeyDown={e => {
                // Removed modal open on keyboard interaction
              }}
            >
              <img
      ...
      {/* Sidebar mobile directly below navbar */}
      <AnimatePresence>
        {toggle && (
          <motion.div
          ...
          >
            <nav className="flex flex-col space-y-6 p-6">
              ...
              <button
                ...
                className="py-3 px-4 rounded-md text-lg text-left transition-colors text-white/80 hover:text-[#915EFF] hover:bg-white/10"
              >
                CV
              </button>
            </nav>
